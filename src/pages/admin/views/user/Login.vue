...
<script>
    import md5 from "md5";
    import TwoStepCaptcha from "@admin/components/tools/TwoStepCaptcha";
    import { mapActions } from "vuex";
    import { timeFix } from "@admin/utils/util";
    import { getSmsCaptcha, get2step } from "@admin/api/login";

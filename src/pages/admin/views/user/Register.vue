        ...
        <a-form ref="formRegister" :form="form" id="formRegister">
            ...
            <a-popover placement="rightTop" :trigger="['focus']" :getPopupContainer="(trigger) => trigger.parentElement" v-model="state.passwordLevelChecked">
                ...
                <a-form-item>
                    <a-input-password
                        ...
                        v-decorator="[
                            'password',
                            { rules: [{ required: true, message: $t('user.password.required') }, { validator: this.handlePasswordLevel }], validateTrigger: ['change', 'blur'] }
                        ]"></a-input-password>
                </a-form-item>
            </a-popover>
            ...
            <a-form-item>
                <a-input-password
                    ...
                    v-decorator="[
                        'password2',
                        { rules: [{ required: true, message: $t('user.password.required') }, { validator: this.handlePasswordCheck }], validateTrigger: ['change', 'blur'] }
                    ]"></a-input-password>
            </a-form-item>
            ...
            <a-form-item>
                <a-input
                    ...
                    v-decorator="[
                        'mobile',
                        {
                            rules: [{ required: true, message: $t('user.phone-number.required'), pattern: /^1[3456789]\d{9}$/ }, { validator: this.handlePhoneCheck }],
...
<script>
    import { getSmsCaptcha } from "@admin/api/login";
    import { deviceMixin } from "@admin/store/device-mixin";
    import { scorePassword } from "@admin/utils/util";

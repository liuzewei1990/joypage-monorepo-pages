...
<script>
    import { colorList } from "@admin/components/SettingDrawer/settingConfig";
    import { baseMixin } from "@admin/store/app-mixin";
    import { NAV_THEME, TOGGLE_NAV_THEME } from "@admin/store/mutation-types";
